...
public class PQLCacheItem implements Cloneable {
	protected static final Logger LOGGER = LoggerFactory.getLogger(PQLCacheItem.class);
	private String pql;
	private StatementSpec spec;
	private Map<Integer, String> bindings = new HashMap<>();

	public static PQLCacheItem newItem(String pql, StatementSpec spec, Map<Integer, String> bindings) {
		PQLCacheItem cacheItem = new PQLCacheItem();
